...
<link href="css/pages.css" rel="stylesheet">
    ...
    <div class="row d-flex m-0 p-0 title-material">
        ...
        <div class="col-12 col-md-10 col-lg-8 text-center py-3 py-md-5 px-5 px-md-0">
            <div class="col-12 py-1 py-md-4 px-md-4  material-base-title-inside-cont text-center">
    ...
    <div class="row d-flex m-0 p-0 content-background-material px-5 px-md-0">
        ...
        <div class="col-12 col-md-10 col-lg-8 p-0">
            <div class="col-12 p-0 m-0"><p class="py-3 text-center blue-header">Навчальний процеc</p>
                <div class="col-12 p-0 d-flex">
                    <div class="col-1 d-none d-sm-flex p-0"></div>
                    <div class="col-12 col-sm-10 d-flex p-0">
                       <p class="text-center basic-text p-0">у повній мірі забезпечений необхідними <span
                class="basic-text-bold">навчальними приміщеннями,</span>  обладнаними необхідними <span
                class="basic-text-bold">приладами</span>  та <span
                class="basic-text-bold">пристроями</span>  для опанування тем навчальної програми. </p> 
                    </div>
                    <div class="col-1 d-none d-sm-flex p-0"></div>
                 </div>
            </div>
            <div class="col-12 p-0 text-center d-flex">
                <div class="col-1"></div>
                <div class="col-10 p-0"><p class="py-5 text-center blue-header">Для викладання спеціальних предметів є 
                    кабінети і лабораторії: </p></div>
                <div class="col-1"></div>
            </div>
            <div class="col-12 p-0 m-0">
                <div class="col-12 d-block d-md-flex p-0  m-0 py-3 py-md-5">
                    <div class="col-12 col-md-6 p-0 text-center text-md-start"><img src="#" class="pr-md-5 w-100">Тут
                        має бути картинка</div>
                    <div class="col-12 col-md-6 text-center text-md-left  align-items-center pl-md-3">
                        <p class="basic-text">Кабінет-лабораторія телекомунікаційних пристроїв приймання та передавання інформації, телевізійної та офісної техніки (ауд.321).
                        </p>
                    </div>
                </div>

                <div class="col-12 d-block d-md-flex p-0  m-0 py-3 py-md-5">
                    <div class="col-12 col-md-6 order-md-last p-0 text-center text-md-start "><img src="#"
                    ...
                    <div class="col-12 col-md-6 align-middle text-center text-md-right order-md-first p-0 pr-md-3">
                        <p class="basic-text">Кабінет-лабораторія конструювання та технології виробництва РЕА, систем автоматизованого проектування (ауд. 306).
                        </p>
                    </div>
                </div>
                <div class="col-12 d-block d-md-flex p-0  m-0 py-3 py-md-5">
                    <div class="col-12 col-md-6 p-0 text-center text-md-start"><img src="#" class="pr-md-5 w-100">Тут
                        має бути картинка</div>
                    <div class="col-12 col-md-6 text-center text-md-left  align-items-center pl-md-3">
                        <p class="basic-text">Кабінет-лабораторія радіопередавальних пристроїв, метрології та вимірювальної техніки (ауд.310) .
                        </p>
                    </div>
                </div>
                ...
                <div class="col-12 d-block d-md-flex p-0  m-0 py-3 py-md-5">
                    <div class="col-12 col-md-6 p-0 text-center text-md-start"><img src="#" class="pr-md-5 w-100">Тут
                        має бути картинка</div>
                    <div class="col-12 col-md-6 text-center text-md-left  align-items-center pl-md-3">
                        <p class="basic-text">Кабінет-лабораторія цифрових пристроїв, сигналів та процесів в радіотехніці, електронних пристроїв та мікроелектроніки (ауд.313).
                        </p>
                    </div>
                </div>
            ...
            <div class="col-12 p-0 text-center d-flex">
                <div class="col-1"></div>
                <div class="col-10 p-0"><p class="py-5 text-center blue-header">Кабінети та лабораторії циклової комісії</p>
               </div>
                <div class="col-1"></div>
            </div>
