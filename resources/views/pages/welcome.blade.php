...
>>>>>>> 83cd90984907a376ba39bd7d0bffaf70b06d962c
      </div>
      <div class="carousel-item">
          ...
          <div class="row col-12 my-4 justify-content-between m-0 p-0">
            <div class="col-12 my-3 d-block d-md-flex px-0">
              <div class="row col-12 col-md-7 p-0 pr-md-3 m-0">
                ...
                <div class="col-12 text-center my-1 my-sm-4"><span id="black-span-heading">{{ $content[3]->text }}</span>
                </div>
...
>>>>>>> 83cd90984907a376ba39bd7d0bffaf70b06d962c
          ...
          <div class="col-12 text-center my-1 my-sm-4">
            <span id="black-span-heading">Одна із перших ЦК в нашому коледжі</span>
          </div>
<<<<<<< HEAD
          <div class="col-12 text-center">
