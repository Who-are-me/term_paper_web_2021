    ...
    <div class="row d-flex m-0 py-5 content-background px-5 px-md-0">
        ...
        <div class="col-12 col-md-10 col-lg-8 p-0">
                ...
                @foreach ($teachers as $item)
                    ...
                    @if (($item->id % 2) != 0)
                        <div class="col-12 d-block d-md-flex p-0  m-0 py-3 py-md-5">
                            <div class="col-12 col-md-4 p-0 text-center text-md-start"><img src="{{ $item->srcimg }}" class="pr-md-5 w-100"></div>
                    ...
                    @else
                        <div class="col-12 d-block d-md-flex p-0  m-0 py-3 py-md-5">
                            <div class="col-12 col-md-4 order-md-last p-0 text-center text-md-start "><img src="{{ $item->srcimg }}" class="w-100 pl-md-5"></div>
            ...
            <div class="col-12 p-0 py-5 m-0">
                <p class="text-center grey-bold-text-heading p-0 py-5">{{ $content[4]->text }}</p>
                <div><?php echo $content[5]->text; ?></div>
            </div>
        </div>
        <div class="col-md-1 col-lg-2 d-none d-md-flex p-0 m-0"></div>
    </div>
