    ...
    <div class="col-12 col-md-10 col-lg-8 p-0 px-5 px-md-0">
        <div class="col-12 p-0 m-0 d-block pb-5">
            ...
            <div class="col-12 p-0 m-0 d-block d-md-flex">
                ...
                <div class="col-12 col-md-8 text-center align-items-center" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="1100">
...
<div class="row d-flex m-0 py-0 content-background-about px-5 px-md-0">
    ...
    <div class="col-12 col-md-10 col-lg-8 p-0">
        <div class="col-12 p-0 m-0 d-block">
            <div class="d-flex col-12 justify-content-between p-0 m-0 py-3 py-md-5 text-center" id="container-heading" data-aos="zoom-out" data-aos-duration="2000">
                <img src="/image/gray-left-heading-separate.svg">
                <span id="grey-span-heading">Склад циклової комісії</span>
                <img src="/image/gray-right-heading-separate.svg">
            </div>

            <img class="w-100 m-0 mb-2 mb-md-5" src="{{ $content[3]->text }}" style="border-radius: 15px;" data-aos="zoom-in" data-aos-duration="2000" data-aos-delay="600">
        ...
        <div class="col-12 p-0 py-0 pb-4 pb-md-0 py-md-5 m-0">
            <p class="text-center grey-bold-text-heading p-0 py-4 py-md-5" data-aos="zoom-out" data-aos-duration="2000">Завданням комісії є підготовка сучасного радіотехніка, фахівця, якому притаманні такі якості:</p>
