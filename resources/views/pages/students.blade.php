...
<div class="row d-flex m-0 p-0 title-student">
        ...
        <div class="col-12 col-md-10 col-lg-8 text-center py-3 py-md-5 px-5 px-md-0">
            <div class="col-12 py-1 py-md-4 px-md-4  for-student-title-inside-cont text-center">
                <span>Студенту</span>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-md-10 col-lg-8 d-block">
        ...
        <div class="col-12 d-block p-0 py-3">
            <div class="col-12 d-flex py-2">
                ...
                <div class="col-8 col-md-6 p-0 text-center">
        ...
        <div class="col-12 p-0 pb-3 p-md-3">
            <div class="slider">
